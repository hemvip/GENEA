...
export const VIDEO_START_UPLOAD_API_ENDPOINT = `${process.env.NEXT_PUBLIC_UPLOAD_VIDEO_API_ENDPOINT}/api/video-start-upload`

// https://video.hemvip.workers.dev/api/video-upload-part
export const VIDEO_UPLOAD_PART_API_ENDPOINT = `${process.env.NEXT_PUBLIC_UPLOAD_VIDEO_API_ENDPOINT}/api/video-upload-part`

// https://video.hemvip.workers.dev/api/video-complete-upload
export const VIDEO_COMPLETE_UPLOAD_API_ENDPOINT = `${process.env.NEXT_PUBLIC_UPLOAD_VIDEO_API_ENDPOINT}/api/video-complete-upload`
